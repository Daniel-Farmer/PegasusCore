...
const features = [
  {
    title: "Notes",
    description: "CRUD operations with Supabase database and RLS",
    href: "/notes",
    icon: (
  ...
  },
  {
    ...
    description: "Vector similarity search powered by pgvector",
    href: "/search",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    title: "AI Chat",
    description: "Streaming chat via Bifrost AI gateway",
    href: "/chat",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-white/40">
          Welcome to Pegasus. Explore the integrations below.
        </p>
      </div>
